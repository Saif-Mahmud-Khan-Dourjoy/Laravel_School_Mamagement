            ...
            paymentMethodsDataTable = $('#paymentMethodsDataTable').DataTable({
                ...
                columns: [
                    ...
                    
                    {
                        ...
                        '<a class="dropdown-item" data-id = ' + data +' href="'+jsUtlt.siteUrl('/payment_methods/' + data)+'"><i class="fa fa-eye"></i>View</a>'+
                        '<a class="dropdown-item" data-id = ' + data + ' href="'+jsUtlt.siteUrl('/payment_methods/' + data)+'/edit"><i class="fa fa-edit"></i>Edit</a>'+
                        '<a class="dropdown-item"><form action="'+jsUtlt.siteUrl('/payment_methods/' + data)+'" method="post">@csrf<input type="hidden" name="_method" value="delete" /><button class="btn-link pl-2"><i style="color:#000;" class="fa fa-trash text-info">  Delete</i></button></form></a>'+
                        '</div></div>';
                        return $return;
                        }
                    }
