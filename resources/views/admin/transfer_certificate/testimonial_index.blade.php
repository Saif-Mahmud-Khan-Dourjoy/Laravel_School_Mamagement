        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading" style="background-color: #f2f2f2;">
                    <h5 class="title" align="center"><strong>Testimonial</strong></h5>
                </div>
                @php
                   // dd($errors->any());
                @endphp
                <div class="panel-body">
                    <div style="padding-top: 2px;">
                        <div style="padding: 10px;">
                            <form id="cr_search_form" method="post" action="{{route('testmonial.pdf')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                	<div class="col-md-12" style="text-align: center;">
                                		<button type="submit" id="cr_search_btn" class="btn btn-round btn-wd">Generate Testmonial</button>
