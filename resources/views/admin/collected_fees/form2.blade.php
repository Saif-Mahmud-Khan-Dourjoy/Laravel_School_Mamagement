            ...
            <div class="col-md-6 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <table class="table-responsive table-bordered" width="100%">
                                        <tr>
                                            <td class="well-sm" ><b>Session:</b> {{$section_student->section->level_enroll->session->name}}</td>
                            ...
                            <div class="row" style="margin-bottom:10px; margin-top:10px;">
                             <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    {!! Form::date('collection_date', isset($collected_fees->collection_date) ? $collected_fees->collection_date : date('Y-m-d'), ['class'=> 'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        {!! Form::number('total_collected', isset($collected_fees->total_collected) ? $collected_fees->total_collected :null, ['required', 'class'=> 'form-control', 'id' => 'total_collected','onchange'=>'collectedCheck()']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                        ...
                        {!! Form::hidden('student_id', $section_student->student_id, ['class'=> 'form-control']) !!}
                        {!! Form::hidden('section_id', $section_student->section_id, ['class'=> 'form-control']) !!}
    ...
    {{--
        ...
        **Systech Digital Limited
        ...
        function collectedCheck(){
            ...
            var  total_collected=$('#total_collected').val();
            if(total_paid<total_collected){
                Swal.fire({
              icon: 'error',
              title: 'Oops...',
              text: 'Paid amount Should be greater than or equal to collected amount',
              footer: ''
          })
            $('#total_collected').val(" "); 
            }
                        ...
                        fees_book_leaf_number:{
                            remote: {
                                ...
                                data: {
                                    ...
                                    fees_book_leaf_number: function()
                                    {

                                        return  $('.validateForm :input[name="fees_book_leaf_number"]').val();
                                    },

                                    prefix_id: function()
                                    {
                                        return $('.validateForm').find('#leaf_prefix').find(":selected").val();
                                    },
                                }
                            },
                        }
