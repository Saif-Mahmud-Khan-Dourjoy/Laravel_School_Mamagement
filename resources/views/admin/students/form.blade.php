...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('roll_no','Global ID.') !!}
            {!! Form::text('roll_no', (isset($student->roll_no) && $student->roll_no != 0) ? $student->roll_no : "Generate automatically", ['class'=> 'form-control', 'readonly' => '']) !!}
        </div>
    </div>     
    <div class="col-md-6">
        <div class="form-group">
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label('admission_class','Admission Class') !!} <span class="text-danger">&#9733; <small>(Numaric)</small></span>
